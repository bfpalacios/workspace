...
public class GestionarActasMBean {
	...
	public void gestorCargaActas(FileUploadEvent e){
		try{
			...
			SesionBO actaTutoria = tutoriaServices.obtenerActaTutoria(ANIO_ACTUAL, PERIODO_ACTUAL,
				      			   	 							      ...
				      			   	 							      getTutoriaModelSelect().getpCodigo(),
				      			   	 							      String.valueOf(getTutoriaModelSelect().getaCodigo()),
				      			   	 							      getTutoriaModelSelect().getSesion(), PROCESO, MODO);
			
			String nombreActa = sesionTutoria.gettAnio() + sesionTutoria.gettPeriodo() + sesionTutoria.gettCodigo() + String.valueOf(sesionTutoria.getSesion());
			...
			if (actaTutoria.getEstadoActa() < 2){
				if (actaTutoria.getEstadoActa() == 0){
					tutoriaServices.guardarActaTutoria(Integer.parseInt(sesionTutoria.gettAnio()), 
	                                                   Integer.parseInt(sesionTutoria.gettPeriodo()), 
	                                                   sesionTutoria.gettCodigo(), 
	                                                   sesionTutoria.getSesion(), 
	                                                   contenidoArchivo, nombreActa, 1);
					mostrarMensaje(4);
				}
				else{
					tutoriaServices.guardarActaTutoria(Integer.parseInt(sesionTutoria.gettAnio()), 
	                                                   ...
	                                                   sesionTutoria.gettCodigo(), 
	                                                   sesionTutoria.getSesion(), 
	                                                   contenidoArchivo, archivoPDF.getFileName(), 2);
					mostrarMensaje(5);
				}
			}
			else{
	...
	public void actualizarAlumno(ValueChangeEvent e) throws Exception{		
		...
		listaAlumnos = alumnoServices.listarAlumnoTutoria(codDocente, getTutoriaModelSelect().getcCodigo(), PROCESO, MODO);
	...
	public void actualizarSesion(ValueChangeEvent e) throws Exception{
		...
		listaSesiones = tutoriaServices.listarSesionTutoria(ANIO_ACTUAL, PERIODO_ACTUAL,
															getTutoriaModelSelect().getcCodigo(), 
															codDocente, 
				                                            codAlumno, PROCESO, MODO);		
		
		List<SesionBO> sesiones = new ArrayList<SesionBO>();
		for (SesionBO sesion : listaSesiones){
			sesion.setDescSesion(String.valueOf(sesion.getNroSesion()) + " - " + formatearFecha(sesion.getFechaTutoria()));
			sesiones.add(sesion);
		}
	...
	public String descargarActa(){	
		...
		switch(PROCESO){
			case 1: switch(MODO_AUX){ 
	 					case 1: pagina = "/paginas/ModuloObservados/admin/cargar/descargarActasTutoria.xhtml"; break;	
	 					case 2: pagina = "/paginas/ModuloObservados/tutor/cargar/descargarActasTutoria.xhtml"; break;	 				
	 					case 3: pagina = "/paginas/ModuloObservados/ocaa/cargar/descargarActasTutoria.xhtml"; break;
	 				} break;
			
			case 2: switch(MODO_AUX){ 
						case 1: pagina = "/paginas/ModuloRegulares/admin/cargar/descargarActasTutoria.xhtml"; break;					
						case 2: pagina = "/paginas/ModuloRegulares/tutor/cargar/descargarActasTutoria.xhtml"; break;
						case 3: pagina = "/paginas/ModuloRegulares/ocaa/cargar/descargarActasTutoria.xhtml"; break;
	 				} break;
		}
		return pagina;
	}
			...
			if(validarOpciones(codCurso, codProfesor, codAlumno, sesion)){
				...
				if (actaTutoria.getEstadoSesion().equals(REGISTRO_FALTANTE)){
					...
					if (actaTutoria.getEstadoActa() == 0){
						...
						InputStream datosActa = new ByteArrayInputStream(actaTutoria.getActa());
						file = new DefaultStreamedContent(datosActa, "application/pdf", actaTutoria.getNombreActa() + ".pdf");				
					}			
				}
			}
		}
		...
		switch(proceso){
			case 1: switch(modo){ 
		 				case 1: PROCESO = PROCESO_OBSERVADOS;
		 						...
		 						listarCursos();
		 						setDesactivarDescarga(true);
		 						pagina = "/paginas/ModuloObservados/admin/cargar/descargarActasTutoria.xhtml"; break;
		 				...
		 				case 2: PROCESO = PROCESO_OBSERVADOS;
		 						...
		 						listarCursos();
		 						setDesactivarDescarga(true);
		 						pagina = "/paginas/ModuloObservados/ocaa/cargar/descargarActasTutoria.xhtml"; break;
		 				...
		 				case 3: PROCESO = PROCESO_OBSERVADOS;
 								...
 								setDesactivarDescarga(true);
 								pagina = "/paginas/ModuloObservados/tutor/cargar/descargarActasTutoria.xhtml"; break;
		 	...
		 	case 2: switch(modo){ 
						case 1: PROCESO = PROCESO_REGULARES;
								...
								listarCursos();
								setDesactivarDescarga(true);
								pagina = "/paginas/ModuloRegulares/admin/cargar/descargarActasTutoria.xhtml"; break;
						...
						case 2: PROCESO = PROCESO_REGULARES;
								...
								listarCursos();
								setDesactivarDescarga(true);
								pagina = "/paginas/ModuloRegulares/ocaa/cargar/descargarActasTutoria.xhtml"; break;
								
						case 3: PROCESO = PROCESO_REGULARES;
								MODO = MODO_TUTOR;
								MODO_AUX = MODO_TUTOR;
								listarCursosxDocente();
								setDesactivarDescarga(true);
								pagina = "/paginas/ModuloRegulares/tutor/cargar/descargarActasTutoria.xhtml"; break;
						
						case 4: PROCESO = PROCESO_REGULARES;
 								MODO = MODO_ADMIN;
 								MODO_AUX = MODO_UNAYOE;
 								listarCursos();
 								setDesactivarDescarga(true);
 								pagina = "/paginas/ModuloRegulares/unayoe/cargar/descargarActasTutoria.xhtml"; break;
		 			} break;
		}
		return pagina;		
	}	
	...
	private void mostrarMensaje(int opcionMensaje){
		 ...
		 switch(opcionMensaje){
		 	case 1: message = new FacesMessage(FacesMessage.SEVERITY_ERROR,"Registro de sesión inexistente","La sesión de tutoría todavía no ha sido registrada");
		 			RequestContext.getCurrentInstance().showMessageInDialog(message); break;
		 	case 2: message = new FacesMessage(FacesMessage.SEVERITY_ERROR,"Acta inexistente","No hay un acta cargada para esta sesión");
		 			RequestContext.getCurrentInstance().showMessageInDialog(message); break;
		 	case 3: message = new FacesMessage(FacesMessage.SEVERITY_WARN,"Límite de actas cargadas","El proceso de carga de tutorías para esta sesión ha finalizado");
		 			RequestContext.getCurrentInstance().showMessageInDialog(message); break;
		 	case 4: message = new FacesMessage(FacesMessage.SEVERITY_INFO,"Carga correcta","El documento se ha cargado correctamente");
		 			RequestContext.getCurrentInstance().showMessageInDialog(message); break;
		 	case 5: message = new FacesMessage(FacesMessage.SEVERITY_INFO,"Actualización correcta","El documento se ha actualizado correctamente");
		 			RequestContext.getCurrentInstance().showMessageInDialog(message); break;
		 	case 6: message = new FacesMessage(FacesMessage.SEVERITY_INFO,"Error","Ha ocurrido un error en el proceso de descarga del acta");
 					RequestContext.getCurrentInstance().showMessageInDialog(message); break;	 
		 	case 7:	message = new FacesMessage(FacesMessage.SEVERITY_ERROR,"", "Debe seleccionar un curso");
 					FacesContext.getCurrentInstance().addMessage(null, message); break;	
		 	case 8:	message = new FacesMessage(FacesMessage.SEVERITY_ERROR,"", "Debe seleccionar un docente");
					FacesContext.getCurrentInstance().addMessage(null, message); break;	
		 	case 9:	message = new FacesMessage(FacesMessage.SEVERITY_ERROR,"", "Debe seleccionar un alumno");
					FacesContext.getCurrentInstance().addMessage(null, message); break;	
